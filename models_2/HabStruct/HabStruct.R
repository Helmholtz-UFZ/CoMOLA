setwd("/Users/victorsteffens/CoMOLA_repo/COMOla/models_2/HabStruct")
sink("/Users/victorsteffens/CoMOLA_repo/COMOla/models_2/HabStruct/console.txt", append=FALSE)
library(here)
##########################################################################################
#
