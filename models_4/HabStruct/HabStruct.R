setwd("/Users/victorsteffens/CoMOLA_repo/COMOla/models_4/HabStruct")
sink("/Users/victorsteffens/CoMOLA_repo/COMOla/models_4/HabStruct/console.txt", append=FALSE)
library(here)
##########################################################################################
#
