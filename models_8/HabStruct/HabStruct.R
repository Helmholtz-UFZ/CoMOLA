setwd("/Users/victorsteffens/CoMOLA_repo/COMOla/models_8/HabStruct")
sink("/Users/victorsteffens/CoMOLA_repo/COMOla/models_8/HabStruct/console.txt", append=FALSE)
library(here)
##########################################################################################
#
