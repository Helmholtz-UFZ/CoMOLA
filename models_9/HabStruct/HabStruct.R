setwd("/Users/victorsteffens/CoMOLA_repo/COMOla/models_9/HabStruct")
sink("/Users/victorsteffens/CoMOLA_repo/COMOla/models_9/HabStruct/console.txt", append=FALSE)
library(here)
##########################################################################################
#
