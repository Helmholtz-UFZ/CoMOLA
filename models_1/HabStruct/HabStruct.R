setwd("/Users/victorsteffens/CoMOLA_repo/COMOla/models_1/HabStruct")
sink("/Users/victorsteffens/CoMOLA_repo/COMOla/models_1/HabStruct/console.txt", append=FALSE)
library(here)
##########################################################################################
#
