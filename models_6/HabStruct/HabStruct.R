setwd("/Users/victorsteffens/CoMOLA_repo/COMOla/models_6/HabStruct")
sink("/Users/victorsteffens/CoMOLA_repo/COMOla/models_6/HabStruct/console.txt", append=FALSE)
library(here)
##########################################################################################
#
