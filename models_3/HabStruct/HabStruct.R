setwd("/Users/victorsteffens/CoMOLA_repo/COMOla/models_3/HabStruct")
sink("/Users/victorsteffens/CoMOLA_repo/COMOla/models_3/HabStruct/console.txt", append=FALSE)
library(here)
##########################################################################################
#
