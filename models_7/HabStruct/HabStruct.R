setwd("/Users/victorsteffens/CoMOLA_repo/COMOla/models_7/HabStruct")
sink("/Users/victorsteffens/CoMOLA_repo/COMOla/models_7/HabStruct/console.txt", append=FALSE)
library(here)
##########################################################################################
#
